 ...
 */
#ifndef RTW_HEADER_part4_prob2_estimator_h_
#define RTW_HEADER_part4_prob2_estimator_h_
#include <string.h>
#ifndef part4_prob2_estimator_COMMON_INCLUDES_
# define part4_prob2_estimator_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* part4_prob2_estimator_COMMON_INCLUDES_ */

#include "part4_prob2_estimator_types.h"
...
#define part4_prob2_estimator_rtModel  RT_MODEL_part4_prob2_estimato_T

/* Block signals (auto storage) */
typedef struct {
  real_T Integrator[6];                /* '<S5>/Integrator' */
  real_T degrad1;                      /* '<Root>/deg->rad1' */
  real_T RateTransitionx;              /* '<S3>/Rate Transition: x' */
  real_T Joystick_gain_x;              /* '<S3>/Joystick_gain_x' */
  real_T invertsteering2;              /* '<Root>/invert steering 2' */
  real_T RateTransitiony;              /* '<S3>/Rate Transition: y' */
  real_T Joystick_gain_y;              /* '<S3>/Joystick_gain_y' */
  real_T invertsteering1;              /* '<Root>/invert steering 1' */
  real_T P_LQR[2];                     /* '<S4>/P_LQR' */
  ...
  real_T Sum2;                         /* '<S4>/Sum2' */
  real_T Sum3;                         /* '<S4>/Sum3' */
  real_T degrad[3];                    /* '<Root>/deg->rad' */
  real_T Sum2_i[6];                    /* '<S5>/Sum2' */
} B_part4_prob2_estimator_T;
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Elevation_est_PWORK;               /* '<Root>/Elevation_est' */

  struct {
    void *LoggedData;
  } Elevationrate_est_PWORK;           /* '<Root>/Elevationrate_est' */

  struct {
    void *LoggedData;
  } pitch_est_PWORK;                   /* '<Root>/pitch_est' */

  struct {
    void *LoggedData;
  } pitchrate_est_PWORK;               /* '<Root>/pitchrate_est' */

  struct {
    void *LoggedData;
  } travel_est_PWORK;                  /* '<Root>/travel_est' */

  struct {
    void *LoggedData;
  } travelrate_est_PWORK;              /* '<Root>/travelrate_est' */
...
#define rtB                            part4_prob2_estimator_B
#define BlockIO                        B_part4_prob2_estimator_T
#define rtX                            part4_prob2_estimator_X
#define ContinuousStates               X_part4_prob2_estimator_T
#define rtXdot                         part4_prob2_estimator_XDot
#define StateDerivatives               XDot_part4_prob2_estimator_T
#define tXdis                          part4_prob2_estimator_XDis
#define StateDisabled                  XDis_part4_prob2_estimator_T
#define rtP                            part4_prob2_estimator_P
#define Parameters                     P_part4_prob2_estimator_T
#define rtDWork                        part4_prob2_estimator_DW
#define D_Work                         DW_part4_prob2_estimator_T

/* Parameters (auto storage) */
struct P_part4_prob2_estimator_T_ {
  real_T A_est[36];                    /* Variable: A_est
                                        * Referenced by: '<S5>/A_est1'
                                        */
  real_T B_est[12];                    /* Variable: B_est
                                        * Referenced by: '<S5>/B_est'
                                        */
  real_T C_est[18];                    /* Variable: C_est
                                        * Referenced by: '<S5>/C_est'
                                        */
  ...
  real_T K_LQR[10];                    /* Variable: K_LQR
                                        ...
                                        */
  real_T L_est[18];                    /* Variable: L_est
                                        * Referenced by: '<S5>/L_est'
                                        */
  real_T P_LQR[4];                     /* Variable: P_LQR
                                        * Referenced by: '<S4>/P_LQR'
                                        */
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T degrad1_Gain;                 /* Expression: 360/2*pi
                                        * Referenced by: '<Root>/deg->rad1'
                                        */
  ...
  real_T Gainx_Gain;                   /* Expression: 10/9
                                        ...
                                        */
  real_T invertsteering2_Gain;         /* Expression: -1
                                        * Referenced by: '<Root>/invert steering 2'
                                        */
  ...
  real_T Gainy_Gain;                   /* Expression: 10/9
                                        ...
                                        */
  real_T invertsteering1_Gain;         /* Expression: -1
                                        * Referenced by: '<Root>/invert steering 1'
                                        */
  ...
  real_T PitchCounttorad_Gain;         /* Expression: 2*pi /4096
                                        ...
                                        */
  real_T Gain_Gain_ey;                 /* Expression: 180/pi
  ...
  real_T BackmotorSaturation_LowerSat; /* Expression: -5
                                        * Referenced by: '<S2>/Back motor: Saturation'
                                        */
  real_T pitchoffset_Value;            /* Expression: -3
                                        * Referenced by: '<Root>/pitch  offset'
                                        */
  real_T elevationoffset1_Value;       /* Expression: 0
                                        * Referenced by: '<Root>/elevation  offset1'
                                        */
...
struct tag_RTM_part4_prob2_estimator_T {
  const char_T *path;
...
extern P_part4_prob2_estimator_T part4_prob2_estimator_P;

/* Block signals (auto storage) */
extern B_part4_prob2_estimator_T part4_prob2_estimator_B;

/* Continuous states (auto storage) */
extern X_part4_prob2_estimator_T part4_prob2_estimator_X;

/* Block states (auto storage) */
extern DW_part4_prob2_estimator_T part4_prob2_estimator_DW;
...
extern void part4_prob2_estimator_initialize(void);
extern void part4_prob2_estimator_output0(void);
extern void part4_prob2_estimator_update0(void);
extern void part4_prob2_estimator_output(int_T tid);
extern void part4_prob2_estimator_update(int_T tid);
extern void part4_prob2_estimator_terminate(void);

/* Real-time Model object */
extern RT_MODEL_part4_prob2_estimato_T *const part4_prob2_estimator_M;
 ...
 *
 * '<Root>' : 'part4_prob2_estimator'
 * '<S1>'   : 'part4_prob2_estimator/Conversion1'
 * '<S2>'   : 'part4_prob2_estimator/Heli 3D1'
 * '<S3>'   : 'part4_prob2_estimator/Joystick1'
 * '<S4>'   : 'part4_prob2_estimator/LQR'
 * '<S5>'   : 'part4_prob2_estimator/Observer'
 * '<S6>'   : 'part4_prob2_estimator/Heli 3D1/Elevation rad to deg'
 * '<S7>'   : 'part4_prob2_estimator/Heli 3D1/Elevation rate rad to deg'
 * '<S8>'   : 'part4_prob2_estimator/Heli 3D1/Pitch rad to deg'
 * '<S9>'   : 'part4_prob2_estimator/Heli 3D1/Pitch rate rad to deg'
 * '<S10>'  : 'part4_prob2_estimator/Heli 3D1/Travel rad to deg'
 * '<S11>'  : 'part4_prob2_estimator/Heli 3D1/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_part4_prob2_estimator_h_ */
